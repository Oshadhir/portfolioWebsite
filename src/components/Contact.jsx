            ...
            <section className="relative w-full mx-auto bg-primary rounded" style={{ margin: 0, padding: 0 }}>
                ...
                <div >
                    <div className="items-center justify-center">
                        <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white z-0 bg-transparent text-center">Feel free to <span className="gradient bg-gradient-to-r from-[#881940] to-[#10127d] bg-clip-text text-transparent z-0">
                            reach out!
                        </span></h1>
                        ...
                        <div className="flex justify-center items-center mt-8">
                            <a
                                ...
                                className="px-6 py-3 text-white font-bold text-xl bg-[#881956]  rounded-lg shadow hover:bg-[#54429a] transition-colors duration-300"
                            >
                                Contact Me
